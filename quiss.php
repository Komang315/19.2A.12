...
<body>
    ...
    <form action="out_quiz.php" method="post">
        <div class="container mt-5">
            <h1 class="mb-3">Tambah Data Rak</h1>
            <div class="mb-3">
                <label for="nama_gedung" class="form-label">Nama Gedung</label>
                <select class="form-select form-select-lg mb-3" name="nama_gedung" aria-label="Large select example">
            ...
            <div class="mb-3">
                ...
                <select class="form-select form-select-lg mb-3" name="nama_lantai" aria-label="Large select example">
            ...
            <div class="mb-3">
                ...
                <select class="form-select form-select-lg mb-3" name="nama_ruang" aria-label="Large select example">
